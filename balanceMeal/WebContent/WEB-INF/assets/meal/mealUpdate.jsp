...
<body>
	...
	<div id="content">
		<div class="addEveryday">
			<h1>均衡餐——编辑</h1>
			<form action="MealUpdateServlet.do" method="post" >
				...
				<div class="select_meal_time">
					<label>标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题：</label>
					<input type="text" name="mealtit" value="${meal.mealtit }" />
				</div>
				<div class="select_meal_time">
					<label>摘&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;要：</label>
					<input class="abstract" type="text" name="mealintro" value="${meal.mealintro }" />
				</div>
				<div class="select_meal_time">
					<label>材&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;料：</label>
					<textarea name="mealmain">${meal.mealmain }</textarea>
				</div>
				<div class="select_meal_time">
					<label>步&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;骤：</label>
					<textarea name="mealcond">${meal.mealcond }</textarea>
				</div>
