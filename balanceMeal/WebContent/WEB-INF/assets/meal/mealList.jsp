...
<body>
	...
	<div id="content">
		<div class="addEveryday">
			<form class="everday_list_search" action="MealListServlet.do" method="post">
				<label>餐点时间：</label>
				...
				<label>发布时间：</label>
				<input type="date" name="mealpublish" value="${queryEverydayMeal.mealpublish }" />
			...
			<div class="e_l_table">
				<ul class="e_l_table_tit">
					...
					<li class="width1">人群</li>
					<li class="width1">标题</li>
					<li class="width1">摘要</li>
					<li>材料</li>
					<li>步骤</li>
					<li>图片</li>
					<li>发布时间</li>
					...
					<!-- 这个属性是用来计数的，varStatus="vs" -->
						...
						<li class="bg1">
							<ul class="e_l_table_list">
								...
								<li class="width1">${everydayMeal.mealpeople }</li>
								<li class="width1">${everydayMeal.mealtit }</li>
								<li class="width1">${everydayMeal.mealintro }</li>
								<li>${everydayMeal.mealmain }</li>
								<li>${everydayMeal.mealcond }</li>
								...
								<li>
									<a href="MealUpdateServlet.do?id=${everydayMeal.id }">编辑&nbsp;&nbsp;|</a>	
									<a href="MealDeleteServlet.do?id=${everydayMeal.id }">&nbsp;删除</a>	
								</li>
							</ul>
						</li>
						</c:forEach>
				...
				<div class="page">
					<a href="MealListServlet.do?pageNow=1">首页</a>
					<a href="MealListServlet.do?pageNow=${pageBean.pageNow-1>0 ? pageBean.pageNow-1:1 }">上一页</a>
					<a href="MealListServlet.do?pageNow=${pageBean.pageNow+1<=pageBean.totalPage ? pageBean.pageNow+1:pageBean.totalPage }">下一页</a>
					<a href="MealListServlet.do?pageNow=${pageBean.totalPage }">尾页</a>
