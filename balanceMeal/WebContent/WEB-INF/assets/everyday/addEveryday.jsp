...
<body>
	...
	<div id="content">
		<div class="addEveryday">
			<form action="AddEverydayServlet.do" method="post"  enctype="multipart/form-data">
				<div class="select_meal_time">
					<label>餐点时间：</label>
					<select name="mealtime" style="margin-right:8%;">
						<option>早餐</option>
						<option>午餐</option>
						<option>下午茶</option>
						<option>晚餐</option>
					...
					<label>发布时间：</label>
					<input type="date" name="mealpublish" style="margin-right:8%;" />
					<label>点赞：</label>
					<input type="text" name="mealzan" />
				</div>
				<div class="select_meal_time">
					<label>标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题：</label>
				...
				<div class="select_meal_time">
					<label>材&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;料：</label>
					<textarea name="mainingredient"></textarea>
				</div>
				<div class="select_meal_time">
					<label>步&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;骤：</label>
					<textarea name="condiment"></textarea>
				</div>
