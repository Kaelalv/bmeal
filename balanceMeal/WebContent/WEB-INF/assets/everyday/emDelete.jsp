...
<body>
	...
	<div id="content">
		<div class="addEveryday">
			<h1>每日一餐——删除</h1>
			<form action="EmDeleteServlet.do" method="post" >
				...
				<div class="select_meal_time">
					<label>标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题：</label>
					<input type="text" name="mealtit" value="${everydayMeal.mealtit }"  readonly="readonly" />
				</div>
				<div class="select_meal_time">
					<label>摘&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;要：</label>
					<input class="abstract" type="text" name="mealintro" value="${everydayMeal.mealintro }" readonly="readonly"  />
				</div>
				<div class="select_meal_time">
					<label>材&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;料：</label>
					<textarea name="mainingredient" readonly="readonly" >${everydayMeal.mainingredient }</textarea>
				</div>
				<div class="select_meal_time">
					<label>步&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;骤：</label>
					<textarea name="condiment" readonly="readonly" >${everydayMeal.condiment }</textarea>
				</div>
