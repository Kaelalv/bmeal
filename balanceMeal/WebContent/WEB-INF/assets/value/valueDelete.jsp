...
<body>
	...
	<div id="content">
		<div class="addEveryday">
			<h1>食物营养价值——删除</h1>
			<form action="ValueDeleteServlet.do" method="post" >
				<input type="hidden" name="id" value="${value.value_id }" />
				
				<div class="select_meal_time">
					<label>标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题：</label>
					<input type="text" name="foodname" value="${value.foodname }"  readonly="readonly" />
				</div>
				<div class="select_meal_time">
					<label>食物价值：</label>
					<input class="abstract" type="text" name="foodvalue" value="${value.foodvalue }" readonly="readonly"  />
				</div>
