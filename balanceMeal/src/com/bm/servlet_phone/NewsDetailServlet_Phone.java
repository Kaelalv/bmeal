 ...
 */
@WebServlet("/NewsDetailServlet_Phone.do")
public class NewsDetailServlet_Phone extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map<String,Object> map = DBUtil.query(sql,new Object[]{newsId.trim()});
