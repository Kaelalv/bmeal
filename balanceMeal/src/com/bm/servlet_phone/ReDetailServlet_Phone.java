 ...
 */
@WebServlet("/ReDetailServlet_Phone.do")
public class ReDetailServlet_Phone extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map<String,Object> map = DBUtil.query(sql,new Object[]{recommendId.trim()});
